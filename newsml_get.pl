...
if(scalar @ARGV<2){
	print STDERR "\nThis script will extract keys from the given newsml file and print them to stdout in the order requested.\n";
	...
	print STDERR "Usage: ./newsml_get.pl [options...] {newsml-file} {key1} {key2}....\n";
	exit 2;
}
