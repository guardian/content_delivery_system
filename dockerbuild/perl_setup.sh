...
# Install Perl modules with cpanm, using --notest to skip tests
./cpanm --notest Amazon::SQS::Simple
./cpanm --notest Log::Any@1.716
./cpanm --notest Data::UUID URL::Encode Net::FTP::Throttle Digest::SHA1 File::Touch Search::Elasticsearch Digest::HMAC_SHA1