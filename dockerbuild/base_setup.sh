...
libdbi-perl libhtml-stream-perl libfile-slurp-unicode-perl cpanminus zlib1g-dev build-essential s3cmd libsqlite3-dev nodejs curl libdbd-pg-perl libxml2-dev libxslt1-dev
